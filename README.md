...
## Environments
- Preview: https://main--2-wknd-trendsetters--angi-acs.aem.page/
- Live: https://main--2-wknd-trendsetters--angi-acs.aem.live/
...
1. Open the `2-wknd-trendsetters` directory in your favorite IDE and start coding :)
